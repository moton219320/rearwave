...
public class ToutiaoArgumentResolver implements HandlerMethodArgumentResolver {
    @Override
    public boolean supportsParameter(MethodParameter methodParameter) {
        return methodParameter.hasParameterAnnotation(DecryptBody.class)
                && methodParameter.getParameterAnnotation(DecryptBody.class).value()== PlatformEnum.TOUTIAO;
    }
